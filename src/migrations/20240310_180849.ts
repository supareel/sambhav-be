...
CREATE TABLE IF NOT EXISTS "facutly" (
	"id" serial PRIMARY KEY NOT NULL,
	"first_name" varchar NOT NULL,
	"last_name" varchar,
	"full_name" varchar,
...
CREATE UNIQUE INDEX IF NOT EXISTS "student_email_idx" ON "student" ("email");
CREATE INDEX IF NOT EXISTS "student_created_at_idx" ON "student" ("created_at");
CREATE UNIQUE INDEX IF NOT EXISTS "facutly_email_idx" ON "facutly" ("email");
CREATE INDEX IF NOT EXISTS "facutly_created_at_idx" ON "facutly" ("created_at");
